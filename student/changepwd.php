...
<div class="wrapper">
	<div class="head">
		...
		<div class="layer2"></div>
                        ...
                        <form action="updatepwd.php" method="post" onsubmit="MM_validateForm('session','','R');return document.MM_returnValue" >
<table width="35%" align="center" bordercolor="#003333" class="pagefont">
	<tr>
		<td align="center" colspan="2">
			<h3 class="style13 style8">Change Password<hr /> </h3>
		</td>
	</tr>
	<tr>
		<td align="center">
            ...
            <tr>
 				<td width="19%">
					<div align="left" class="style30">Old Password</div>
				</td>
                <td width="30%">
                    <input name="opwd" type="password" id="pwd" maxlength="10"  />
                </td>
			</tr>
			<tr>
                <td width="19%">
					<div align="left" class="style30">New Password</div>
				</td>
                <td width="30%">
                    <input name="npwd" type="password" id="pwd" maxlength="10"  />
                </td>
			</tr>
			<tr>
            	<td colspan="2" align="center">
					<div align="center" class="style31">
                    <h3><input name="ok" type="submit" class="style30" value="Change" />						 						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="stlogin.php"><span class="style14 style13">Exit</span></a>
					</h3>
					</div>
				</td>
			</tr>
