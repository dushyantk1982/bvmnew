...
<div class="wrapper">
	...
	<div class="container">
		...
		?>
		<iframe align="middle" height="470" width="100%" src="course_detail_count.php" name="sthome"></iframe>
		<?php
		...
		?>
		<iframe align="middle" height="470" width="100%" src="update_std_wise.php" name="sthome"></iframe>
		<?php
