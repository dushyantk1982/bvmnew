...
<body><div class="style2" id="Layer4" style="border:solid;border-color:#003300;">
                        <form action="course_detail.php" method="post" onsubmit="MM_validateForm('session','','R');return document.MM_returnValue" >
						  ...
						  <tr>
							...
							<tr>
                              <td width="31%"><div align="center" class="style30">Number of Subjects</div></td>
                              <td width="100%">
