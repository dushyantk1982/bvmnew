...
<form action="distributorform.php?id=distributorform" method="post">

<table height="100" width="80%" align="center" border="0" bgcolor="#E8E8E8" bordercolor="#E8E8E8">
	<tr>
		<td valign="top" width="80%" align="left" bgcolor="#008B00" colspan="4" height="2"><font color="#FFFFFF">Distributor Detail</font></td>
	</tr>
	<tr>
		<td align="left" bgcolor="#E8E8E8" height="1">
			Distributor Name&nbsp;</td><td><input name="distributorname" type="text" size="30" style="background-color:#CCCCCC;" placeholder="Distributor Name" /></td><td>Date of Birth&nbsp;</td><td><label for="from"></label><input type="text" id="from" name="from" size="30" style="background-color:#CCCCCC;" placeholder="MM/DD/YYYY" /></td></tr><tr><td>
...
if(strcmp($id,"")!=0)
{
	$q="insert into distributor_reg values('".$id."','".$distributor_name."','".$owner_name."','".$dob."','".$gender."','".$mail."','".$address1."','".$address2."','".$district."','".$state."',".$mobile1.",".$mobile2.",".$pin_no.",'".$bank_name."',".$account_no.",'".$bank_branch."','".$pan_no."','".$pwd."')";
