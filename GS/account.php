...
<div class="wrapper">
	...
	<div class="container">
		...
		if(@$_REQUEST['id']==1){
		?>
		<iframe height="500" width="100%" src="payment_to_HB.php" name="account"></iframe>
		<!--<iframe align="middle" height="400" width="400" src="payment_to_HB.php" name="account">-->
		<?php }
		else if(@$_REQUEST['id']==2){
		?>
		<iframe height="500" width="100%" src="pay_frm_retailer.php" name="account"></iframe>
		<?php
		}
		...
		?>
		<iframe height="500" width="100%" src="retailrate.php" name="account"></iframe>
		<?php
		}
		else if(@$_REQUEST['id']==5){
		?>
		<iframe height="500" width="100%" src="distribuorcommrate.php" name="account"></iframe>
		<?php
		}
		?>
		</div>
