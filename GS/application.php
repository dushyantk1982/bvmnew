...
<div class="wrapper">
	...
	<div class="container">
		...
		if(@$_REQUEST['id']==1){
		?>
		<iframe height="700" width="100%" src="motorapp.php" name="account"></iframe>
		<!--<iframe align="middle" height="400" width="400" src="payment_to_HB.php" name="account">-->
		<?php }
		else if(@$_REQUEST['id']==2){
		?>
		<iframe height="700" width="100%" src="othapp.php" name="account"></iframe>
		<?php
		}
	...
	<div class="footer">
		<div class="footer1"><center>&copy;General Insurence/</center><!--<a href="#">Developed By:</a>--></div>
