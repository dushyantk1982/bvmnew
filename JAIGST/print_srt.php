...
<?php
    ...
    return $string;
			...
			$res=mysql_query("select * from sales_ret where srt_no='".$invoice_no."'");
            ...
            <div style="margin-left:auto; margin-right:auto; height:586px;">
                ...
                <table style="width:100%;">
                	<tr>
                    	<td style="width:600px; margin-left:10px;">
                        	<table>
							<tr>
                    	<td style="text-align:left; font-size:12; font-weight:bolder;">Credit To </td><td style="text-align:left; font-size:12; font-weight:bolder;">: <?php echo $client_name; ?></td></tr>
                    ...
                    <td>
                    	<table>
                        	<tr><td></td><td></td><td style="text-align:left; font-size:12; font-weight:bolder; margin-left:50px;">Credit Note No. </td><td style="text-align:left; font-size:12; font-weight:bolder;">: <?php echo "CR".$invoice_no."&nbsp;"; ?></td></tr>
                ...
                <div style="margin-left:auto; margin-right:auto; font-size:12px; font-family:'Courier New', Courier, monospace; height:250px;">
					<?php
                		$s=1;
						$res2=mysql_query("select item.item, item.MRP, item_stock.srt_qty, item_stock.srt_rate, item_stock.srt_base, item_stock.cgst_rate, item_stock.cgst, item_stock.sgst_rate, item_stock.sgst, item_stock.net_amt from item_stock join item on item.item_id=item_stock.item_id where invoice_no='".$invoice_no."' and trn_type='SRT'");
						//echo "select item.item, item.MRP, item_stock.srt_qty, item_stock.srt_rate, item_stock.srt_base, item_stock.cgst_rate, item_stock.cgst, item_stock.sgst_rate, item_stock.sgst, item_stock.net_amt from item_stock join item on item.item_id=item_stock.item_id where invoice_no='".$invoice_no."' and trn_type='SRT'";
				...
				<div style="margin-left:auto; margin-right:auto; font-size:12px; font-family:'Courier New', Courier, monospace; height:15px; border-top:1px solid #000; border-bottom:1px solid #000;">
                		<?php
							$res3=mysql_query("select * from sales.ret where srt_no='".$invoice_no."'");
