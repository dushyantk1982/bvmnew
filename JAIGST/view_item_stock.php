                              ...
                              <!--  <input type="submit" name="submit" value="Search" />
								...
								echo '<div class="box-content box-table">
									...
									while($r=mysql_fetch_array($res))
									{
										...
										$res1=mysql_query("select date, invoice_no, pur_qty, sales_qty, prt_qty, srt_qty, trn_type from item_stock where item_id='".$item_id."'");
										while($r1=mysql_fetch_array($res1))
										{
											$date = strtotime($r1[0]);
											$inv_date=date('d/m/Y', $date);
										echo "<tr><td>".$inv_date."</td><td>".$r1[1]."</td><td>".$r1[6]."</td>";
										if($r1[5]!=0)
										{echo "<td>".$r1[5]."</td>"; }
										else 
										echo "<td>".$r1[2]."</td>";
										...
										echo "<td>".$val."</td></tr>";
											...
											//$i=$i+1;
															...
															echo "<tr><td colspan='6' style='align:center;'><b>Total</b></td><td><b>".$totval."</b></td></tr>";
