		...
		<section id="my-account-security-form" class="page container">
				...
				<div class="container">
					<div class="row">
                        ...
                        <a href="create_sr.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Create Sales Return</button></a>
                        <div class="box-content box-table">
                            <form action="edit_srt.php" method="post">
                              	<input type='text' name='invoice_no' value="">	
                                <input type="submit" name="submit" value="Edit Return " class="btn btn-primary" />
                            </form>
                            <form action="view_srt.php" method="post">
									...
									?>
                                <input type="submit" name="submit" value="View Cr Note " class="btn btn-primary" />
                            </form>
                            ...
                            <table id="sample-table" class="table table-hover table-bordered tablesorter">
								...
								$s=1;
										...
										$res=mysql_query("select sales_ret.date, sales_ret.srt_no, client.client_name, sales_ret.totalnetval, sales_ret.cgst, sales_ret.sgst, sales_ret.igst, sales_ret.discount, sales_ret.netamount from sales_ret join client on sales_ret.client_id=client.client_id order by sales_ret.srt_no DESC LIMIT 800 ");
										...
										while($r=mysql_fetch_array($res))
										{
											echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td>".$r[3]."</td><td>".$r[4]."</td><td>".$r[5]."</td><td>".$r[6]."</td><td>".$r[7]."</td><td>".$r[8]."</td>";?><td class='td-actions'>
                                            	<a href="JavaScript:newPopup('print_srt.php?invoice_no=<?php echo $r[1]; ?>');" class="btn btn-small btn-info">
                                            	    <i class="btn-icon-only icon-print"></i>
                                            	</a>
												<a href="JavaScript:newPopup('view_srt.php?invoice_no=<?php echo $r[1]; ?>');" class="btn btn-small btn-info">
                                            	    <i class="btn-icon-only icon-eye-open">View</i>
                                            	</a>
												<a href="edit_srt.php?invoice_no="<?php echo $r[1]; ?>" class="btn btn-small btn-info">
