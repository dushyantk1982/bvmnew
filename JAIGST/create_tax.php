...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="INSERT INTO `tax` (`tax_id`, `cat`, `tax`, `rate`, `exmpt`) VALUES ('', '".$cat."', '".$tax."', '".$rate."', '".$exmpt."')";
				mysql_query($q);
								...
								<legend>Add New Tax</legend><br>
                                    ...
                                    <div class="control-group ">
										<label class="control-label">Tax Name</label>
											<div class="controls">
												<input id="tax" name="tax" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">Tax Rate %</label>
											<div class="controls">
												<input id="rate" name="rate" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
										<label class="control-label">Exemption %</label>
											<div class="controls">
												<input id="exmpt" name="exmpt" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
							</fieldset>
						</div>
