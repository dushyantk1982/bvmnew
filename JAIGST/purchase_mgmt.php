		...
		<section id="my-account-security-form" class="page container">
				...
				<div class="container">
					<div class="row">
                        ...
                        <a href="combo_break.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Combo Break</button></a>
                        <a href="create_vendor.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Create New Vendor</button></a>
                        <a href="create_item_purchase.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Create New Item</button></a>
                        <a href="create_purchase.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Create New Purchase</button></a>
                        <a href="create_purchase1.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Add Purchase</button></a>
                        <div class="box-content box-table">
                            <!--<form action="view_invoice.php" method="post">
                            	<select name="invoice_no" required>
                                	<?php
                                    	/*include('DAL/database.php');
										$res=mysql_query("select * from invoice group by invoice_no ORDER BY date DESC");
                            ...
                            <table id="sample-table" class="table table-hover table-bordered tablesorter">
								...
								$s=1;
										...
										$res=mysql_query("select purchase.date, purchase.invoice_no, vendor.vendor_name, purchase.total_taxable, purchase.total_vat, purchase.total_net from purchase join vendor on purchase.vendor_id=vendor.vendor_id order by purchase.date DESC LIMIT 20 ");
										...
										while($r=mysql_fetch_array($res))
										{
											echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td>".$r[3]."</td><td>".$r[4]."</td><td>".$r[5]."</td><td class='td-actions'>
                                            	<a href='view_invoice.php?invoice_no=$r[1]' class='btn btn-small btn-info'>
                                            	    <i class='btn-icon-only icon-eye-open'>View</i>
                                            	</a>
												<a href='edit_purchase.php?invoice_no=$r[1]' class='btn btn-small btn-info'>
                                                	<i class='btn-icon-only icon-edit'></i>
                                            	</a>
                                           		<a href='del_purchase.php?invoice_no=$r[1]' onClick='confirmDelete();' class='btn btn-small btn-danger'>
