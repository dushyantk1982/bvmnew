            				...
            				<div class="span16">
								...
								<?php
                                	if($_REQUEST['submit']=='Search')
									{
										...
										$i=1;
										?>
										<a href="JavaScript:newPopup('print_purchase_report.php?date_from=<?php echo $date_from; ?>&date_to=<?php echo $date_to;?>');" class="btn btn-small btn-info">Print Report</a>
										<?php 
										...
										//echo "SELECT purchase.date, purchase.invoice_no, vendors.vendor_name, purchase.totalnetval, purchase.cgst, purchase.sgst, purchase.discount, purchase.netamount  FROM `purchase` JOIN vendors on purchase.vendor_id=vendors.vendor_id where date BETWEEN '".$date_from."' and '".$date_to."'";
										...
										while($r=mysql_fetch_array($res))
										{
											...
											$v=$r[3]+$r[4]+$r[5];
											echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td>".$r[3]."</td><td>".$r[4]."</td><td>".$r[5]."</td><td>".$v."</td><td>".$r[6]."</td><td>".$r[7]."</td></tr>";
											$i=$i+1;
