...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="update `tax` set `cat`='".$cat."', `tax`='".$tax."', `rate`='".$rate."', `exmpt`='".$exmpt."' where tax_id='".$tax_id."'";
				mysql_query($q);
				header('location:tax_mgmt.php');
			}
        	
			$tax_id=$_REQUEST['tax_id'];
			$res=mysql_query("select * from tax where tax_id='".$tax_id."'");
								...
								<legend>Add New Tax</legend><br>
                                    ...
                                    <div class="control-group ">
										<label class="control-label">Tax Name</label>
											<div class="controls">
												<input id="tax" name="tax" class="span4" type="text" value="<?php echo $r[2];?>" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">Tax Rate %</label>
											<div class="controls">
												<input id="rate" name="rate" class="span4" type="text" value="<?php echo $r[3]; ?>" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
										<label class="control-label">Exemption %</label>
											<div class="controls">
												<input id="exmpt" name="exmpt" class="span4" type="text" value="<?php echo $r[4]; ?>" autocomplete="false" required>
                                                <input id="tax_id" name="tax_id" class="span4" type="hidden" value="<?php echo $r[0]; ?>" autocomplete="false" required>
											</div>
									</div>
							</fieldset>
						</div>
