                                  	...
                                  	<td colspan="2">
                                  		<table>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="item_id<?php echo $r[0]; ?>" name="item_id[]" class="span2" type="text" value="<?php echo $r[0]; ?>" autocomplete="false" required></td>
                                                <td><input id="item_name<?php echo $r[1]; ?>" name="item_name[]" class="span2" type="text" value="<?php echo $r[1]; ?>" autocomplete="false" required></td>
                                                <td><input id="MRP<?php echo $r[2]; ?>" name="MRP[]" class="span2" type="text" value="<?php echo $r[2]; ?>" autocomplete="false" required></td>
                                                <td><input id="closing<?php echo $bal; ?>" name="closing[]" class="span2" type="text" value="<?php echo $bal; ?>" autocomplete="false" required></td>
