		...
		<section id="my-account-security-form" class="page container">
				...
				<div class="container">
					<div class="row">
                        ...
                        <a href="create_bank.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Add New Bank</button></a>
                        <div class="box-content box-table">
                            <table id="sample-table" class="table table-hover table-bordered tablesorter">
                                ...
                                <?php
										...
										{
											echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td class='td-actions'>
                                            	<a href='view_bank.php?opt=2&bank_id=$r[0]' class='btn btn-small btn-info'>
                                            	    <i class='btn-icon-only icon-eye-open'>View</i>
                                            	</a>
												<a href='edit_bank.php?opt=3&bank_id=$r[0]' class='btn btn-small btn-info'>
                                                	<i class='btn-icon-only icon-edit'></i>
                                            	</a>
                                           		<a href='del_bank.php?opt=2&bank_id=$r[0]' onClick='confirmDelete();' class='btn btn-small btn-danger'>
