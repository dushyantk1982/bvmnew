						...
						<div id="acct-password-row" class="span16">
                        	<table width="100%">
                                ...
                                <tr><td>Client Name</td><td><select name="client_id" class="span5" required>
                                                ...
                                                <tr><td><input type="hidden" name="cat" value="<?php echo $_POST['cat']; ?>"  /></td></tr>
                                  	...
                                  	<td colspan="2">
                                  		<table>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="baserate<?php echo $i; ?>" name="baserate[]" class="span2" type="text" width="5" value="" onKeyUp="total(<?php echo $i; ?>)" autocomplete="true" required></td>             
