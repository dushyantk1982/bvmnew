            				...
            				<div class="span16">
								...
								<?php
                                	if($_REQUEST['submit']=='Search')
									{
										...
										$i=1;
										?>
										<a href="JavaScript:newPopup('print_gst_sales_report.php?date_from=<?php echo $date_from; ?>&date_to=<?php echo $date_to;?>');" class="btn btn-small btn-info">Print Report</a>
										<?php 
