...
<div class="box">
	...
	<div class="box-content">
		<section id="my-account-security-form" class="page container">
            ...
            <form action="create_sales_2.php" name="company_profile" class="form-horizontal" method="post">
				<div class="container">
					<div class="row">
                                  	...
                                  	<td colspan="2">
                                  		<table>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="rate<?php echo $i; ?>" name="rate[]" class="span2" type="text" width="5" value="" onKeyUp="total(<?php echo $i; ?>)" autocomplete="true" ></td>             
                                                
                                               
                                                <td><input id="netval<?php echo $i; ?>" name="netval[]" class="span2" type="text" onBlur="netvalTOT(<?php echo $i; ?>)" value="" autocomplete="false" ></td>
