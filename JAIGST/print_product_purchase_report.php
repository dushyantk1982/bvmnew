            				...
            				<div class="span16">
                                ...
                                <div align="center" style="margin-top:20px;">
                                	<?php 
										$item=$_REQUEST['item'];
										include('DAL/database.php');
										$res3=mysql_query("select * from item where item_id='".$item."'");
										while($r3=mysql_fetch_array($res3))
										{
											echo "<span style='border-bottom:1px solid;'>".$r3[1]."</span><br/>";		
										}
                                ...
                                <div align="center" style="margin-top:20px; font-size:16px;">
								<?php
										...
										echo '<div class="box-content box-table">
                            					<table id="sample-table" class="table table-hover table-bordered tablesorter" >
                              					  <thead>
                                        				...
                                        				<th style="border-bottom:1px solid; border-top:1px solid;">Invoice No</th>
														<th style="border-bottom:1px solid; border-top:1px solid;">Name</th>
														<th style="border-bottom:1px solid; border-top:1px solid;">Quantity</th>
														<th style="border-bottom:1px solid; border-top:1px solid;">Base Rate</th>
														<th style="border-bottom:1px solid; border-top:1px solid;">Base Purchase</th>
														<th style="border-bottom:1px solid; border-top:1px solid;">CGST</th>
														<th style="border-bottom:1px solid; border-top:1px solid;">SGST</th>
														<th style="border-bottom:1px solid; border-top:1px solid;">Net Purchase</th>
														
                                    				</tr>
                                				</thead>
                                			<tbody>';
										//$res=mysql_query("select * from currency_value where date between '".$date_from."' and '".$date_to."'");
										$res=mysql_query("SELECT s.date, s.invoice_no, c.vendor_name, s.pur_qty, s.pur_rate, s.basepur, s.cgst, s.sgst, s.net_amt  FROM `item_stock` as `s` INNER JOIN `vendors` as `c` on `s`.`client_id`=`c`.`vendor_id` where (s.date BETWEEN '".$date_from."' and '".$date_to."') AND s.item_id='".$item."' and trn_type='PURCHASE'");
										...
										while($r=mysql_fetch_array($res))
										{
											...
											echo "<tr ><td>&nbsp;&nbsp;".$ndt."&nbsp;&nbsp;</td><td>&nbsp;&nbsp;".$r[1]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[2]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[3]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[4]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[5]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[6]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[7]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[8]."&nbsp;&nbsp;</td></tr>";
											$i=$i+1;												
										}
										$res1=mysql_query("select sum(pur_qty)  as pur_qty, sum(basepur) as basepur, sum(cgst) as cgst, sum(sgst) as sgst, sum(net_amt) as net_amt from item_stock where (date BETWEEN '".$date_from."' and '".$date_to."') AND item_id='".$item."' and trn_type='PURCHASE'");
										while($r1=mysql_fetch_array($res1))
										{
											echo "<tr><td colspan='3' align='center' style='border-bottom:1px solid; border-top:1px solid;'><b>Total</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['pur_qty']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['basepur']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['cgst']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['sgst']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['net_amt']."&nbsp;&nbsp;</b></td></tr>";				
										}
										echo "</table>";
