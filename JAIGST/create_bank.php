...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="INSERT INTO `bank` (`bank_id`, `bank`, `bank_add`, `account_name`, `account_no`, `account_type`, `IFSC`, `SWIFT`) VALUES ('', '".$bank."', '".$bank_add."', '".$account_name."', '".$account_no."', '".$account_type."', '".$IFSC."', '".$SWIFT."')";
				mysql_query($q);
								...
								<legend>Add New Bank</legend><br>
									<div class="control-group ">
										<label class="control-label">Bank Name</label>
											<div class="controls">
												<input id="bank" name="bank" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
										<label class="control-label">Address</label>
											<div class="controls">
												<input id="bank_add" name="bank_add" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">Account Holding Name</label>
											<div class="controls">
												<input id="account_name" name="account_name" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">Account No.</label>
											<div class="controls">
												<input id="account_no" name="account_no" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
                                    ...
                                    <div class="control-group ">
										<label class="control-label">IFSC Code</label>
											<div class="controls">
												<input id="IFSC" name="IFSC" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">SWIFT BIC Code</label>
											<div class="controls">
												<input id="SWIFT" name="SWIFT" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
							</fieldset>
						</div>
