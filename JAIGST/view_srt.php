...
<div class="box">
	<div class="container">
        ...
        <a href="JavaScript:newPopup('print_srt.php?invoice_no=<?php echo $invoice_no;?>');">Print Bill</a>
        	<table align="center" height="600" width="900" style="border:1px solid #000;">
            <tr><td align="center" colspan="2"><font style="font-size:12px;">Credit Note</font></td></tr>
            <tr><td align="center" colspan="2"><font style="font-size:14px; font-weight:bold;"><?php echo $company_name; ?></font><br/><font style="font-size:12px;"><?php echo $company_add; ?></font><br/><font style="font-size:12px;">GSTIN No. : <?php echo $company_gst; ?></font></td></tr>
            	<tr>
                	<td>
                    	<table width="100%" style="margin-left:20px;">
                        	<tr><td style="font-size:12px; font-weight:bold;">Credit to</td><td style="font-size:12px; font-weight:bold;"> : <?php echo $client_name; ?></td></tr>
                    ...
                    <td>
                    	<table width="100%">
                            ...
                            <tr><td align="left" ><font style="font-size:12px; margin-left:500px;">Cr No.: <?php echo "CR".$invoice_no; ?></font></td></tr>
                	...
                	<td colspan="2">
                    	<table width="90%" style="margin-left:20px;">
                            ...
                            <?php
								...
								$res3=mysql_query("select * from sales_ret where srt_no='".$invoice_no."'");
                ...
                <td colspan="2">
                    	<?php
                        	$res7=mysql_query("select * from sales_ret where srt_no='".$invoice_no."'");
                ...
                <tr><td><a href="JavaScript:newPopup('print_srt.php?invoice_no=<?php echo $invoice_no;?>');">Print Bill</a></td></tr>
            </table>
