...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="update `unit` set `unit`='".$symbol."', `description`='".$description."' where unit_id='".$unit_id."'";
				mysql_query($q);
				header('location:currency_mgmt.php');
			}
			$unit_id=$_REQUEST['unit_id'];
        	$res=mysql_query("select * from unit where unit_id='".$unit_id."'");
									...
									<div class="control-group ">
										<label class="control-label">Description</label>
											<div class="controls">
                                                ...
                                                <input id="unit_id" name="unit_id" class="span4" type="hidden" value="<?php echo $r[0]; ?>" autocomplete="false" required>
											</div>
									</div>
							</fieldset>
						</div>
