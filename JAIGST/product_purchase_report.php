                       ...
                       <div class="row" style="margin-top: 25px;">
            				<div class="span16">
								...
								<?php
									...
									echo "<select name='item'><option value=''>Select Product</option>";
								...
								<?php
                                	if($_REQUEST['submit']=='Search')
									{
										...
										$i=1;
										?>
										<a href="JavaScript:newPopup('print_product_purchase_report.php?date_from=<?php echo $date_from; ?>&date_to=<?php echo $date_to;?>&item=<?php echo $item;?>');" class="btn btn-small btn-info">Print Report</a>
										<?php 
										...
										//echo "SELECT s.date, s.invoice_no, c.vendor_name, s.pur_qty, s.pur_rate, s.basepur, s.cgst, s.sgst, s.net_amt  FROM `item_stock` as `s` INNER JOIN `vendors` as `c` on `s`.`client_id`=`c`.`vendor_id` where (s.date BETWEEN '".$date_from."' and '".$date_to."') AND s.item_id='".$item."'";
										...
										{
											echo "<tr><td colspan='3' style='align:center;'><b>Total</b></td><td><b>".$r1['pur_qty']."</b><td><b>&nbsp;</b></td><td><b>".$r1['basepur']."</b></td><td><b>".$r1['cgst']."</b></td><td><b>".$r1['sgst']."</b></td><td><b>".$r1['net_amt']."</b></td></tr>";				
										}
										echo "</table>";	
