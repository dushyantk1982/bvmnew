...
<div class="box">
	...
	<div class="box-content">
		<section id="my-account-security-form" class="page container">
			...
			{*/?>
        	<!--<form action="sales_query.php" name="company_profile" class="form-horizontal" method="post">-->
            <form action="create_sales2.php" name="company_profile" class="form-horizontal" method="post">
				<div class="container">
					<div class="row">
						<div id="acct-password-row" class="span16">
                        	<table width="100%">
                            	
                                <tr><td>Date</td><td><input type="date" name="inv_date" value="<?php echo $_POST['inv_date']; ?>" class="span5" autocomplete="false" required></td></tr>
                               						 <?php
													...
													?>
                                <tr><td>Invoice No</td><td><input type="text" name="inv_no" value="<?php echo $_POST['inv_no']; ?>" class="span5" autocomplete="false" required></td></tr>
                                <tr><td>State</td><td><input type="text" name="state" value="<?php echo $_POST['state']; ?>" class="span5" autocomplete="false" required></td>
                                <!--<td>State</td><td><select name="state" class="span5" required>
                                ...
                                <input type="text" name="client_id" value="<?php echo $_POST['client_id']; ?>" class="span5" autocomplete="false" required></td>
                                <?php
								...
								?>
                                <td><input type="text" name="client_name" value="<?php echo $client_name; ?>" class="span5" autocomplete="false" required></td>
                                  	...
                                  	<td colspan="2">
                                  		<table>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="item_id[]" name="item_id[]" class="span4" type="text" value="<?php echo $item_id[$i]; ?>" autocomplete="false" required></td>
                                                <td><input id="item_name" name="item_name[]" class="span2" type="text" value="<?php 
													$res1=mysql_query("select item from item where item_id='".$_POST['item_id']."'");
													while($r1=mysql_fetch_array($res1))
													{echo $r1[0];}
												 ?>" autocomplete="false" required></td>
                                                <td><input id="MRP[]" name="MRP[]" class="span2" type="text" value="<?php echo $MRP[$i]; ?>" autocomplete="false" required></td>
                                                <td><input id="closing[]" name="closing[]" class="span2" type="text" value="<?php echo $_POST['closing']; ?>" autocomplete="false" required></td>
                                                <td><input id="qty<?php echo $i; ?>" name="qty[]" class="span2" type="text" value="" onKeyUp="total(<?php echo $_POST['qty']; ?>)" autocomplete="false" required></td>
                                                <td><input id="rate<?php echo $i; ?>" name="rate[]" class="span2" type="text" width="5" value="" onKeyUp="total(<?php echo $i; ?>)" autocomplete="true" required></td>             
                                            ...
                                            </tr><?php $row=$row+1; } ?><input type="hidden" value="<?php echo $row; ?>">
