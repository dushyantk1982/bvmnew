			...
			if($_REQUEST['submit']=='Save')
			{
				...
				for($i=0;$i<count($item_id);$i++)
				{
					...
					$totsgst=$totsgst+$sgst[$i];
						...
						$q="update item_stock set date='".$inv_date."', client_id='".$client_id."', srt_qty='".$qty[$i]."', srt_rate='".$baserate[$i]."', srt_base='".$netval[$i]."', cgst_rate='".$rcgst[$i]."', cgst='".$cgst[$i]."', sgst_rate='".$rsgst[$i]."', sgst='".$sgst[$i]."', net_amt='".$netamt[$i]."' where stock_id='".$stock_id[$i]."' and trn_type='SRT'";
						//echo $q.'<br/>';
						mysql_query($q);
				}
					...
					$q1="update sales_ret set date='".$inv_date."', client_id='".$client_id."', totalnetval='".$totalnetval."', cgst='".$totcgst."', sgst='".$totsgst."', grossamount='".$netamount1."', discount='".$discount."', netamount='".$netpay."' where srt_no='".$inv_no."'";
					//echo $q1.'<br/>';
					mysql_query($q1);
					
					$q2="update gstdetail set date='".$inv_date."', client_id='".$client_id."', totalnetval='".$totalnetval."',	cgst9='".$tot9cgst."', cgst6='".$tot6cgst."', cgst25='".$tot25cgst."', cgst14='".$tot14cgst."', cgst0='".$tot0cgst."', sgst9='".$tot9sgst."', sgst6='".$tot6sgst."', sgst25='".$tot25sgst."', sgst14='".$tot14sgst."', sgst0='".$tot0sgst."', netamount='".$netpay."' where invoice_no='".$inv_no."' and trn_type='SRT'";
					//echo $q2.'<br/>';
					mysql_query($q2);
					...
					if($old_value!=$netpay)
					{
						if($old_value<$netpay)
						{
							...
							$q3="update debtors set date='".$inv_date."', client_id='".$client_id."', rect_value='".$netpay."', balance='".$new_balance."' where trn_id='".$trn_id."'";
							//echo $q3.'<br/>';
							mysql_query($q3);
						}	
...
<div class="box">
	...
	<div class="box-content">
		<section id="my-account-security-form" class="page container">
			...
			//{
				$res5=mysql_query("select sales_ret.date, client.client_id, client.client_name from sales_ret join client on sales_ret.client_id=client.client_id where srt_no='".$invoice_no."'");
        	...
        	<form action="" name="company_profile" class="form-horizontal" method="post">
				<div class="container">
					<div class="row">
						<div id="acct-password-row" class="span16">
                        	<table width="100%">
                                  ...
                                  <tr>
                                  	...
                                  	<td colspan="2">
                                  		<table>
                                            ...
                                            <?php $res6=mysql_query("SELECT item.item_id, item.item, item.MRP, item_stock.srt_qty, item_stock.srt_rate, item_stock.cgst_rate, item_stock.sgst_rate, item_stock.stock_id  from item_stock JOIN item on item.item_id=item_stock.item_id WHERE invoice_no='".$invoice_no."' and trn_type='SRT'");
								...
								$res7=mysql_query("select discount from sales_srt where srt_no='".$invoice_no."'");
					...
					<footer id="submit-actions" class="form-actions">
						...
						<a href="append_srt.php?invoice_no=<?php echo $invoice_no; ?>&client=<?php echo $client_id; ?>&date=<?php echo $date; ?>" class="btn btn-primary">Add More Item</a>
					</footer>
				</div>
