		...
		<section id="my-account-security-form" class="page container">
				...
				<div class="container">
					<div class="row">
                        ...
                        <a href="create_item.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Add New Item</button></a>
                        ...
                        <div class="box-content box-table">
                            <table id="sample-table" class="table table-hover table-bordered tablesorter">
                                ...
                                <?php
										...
										$res=mysql_query("select item.item_id, item.item, item.description, category.category, item.MRP, item.baserate, item.vat from item join category on item.category=category.category_id");
										while($r=mysql_fetch_array($res))
										{
											echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td>".$r[3]."</td><td>".$r[4]."</td><td>".$r[5]."</td><td>".$r[6]."%</td><td class='td-actions'>
                                            	<a href='edit_item.php?opt=3&item_id=$r[0]' class='btn btn-small btn-info'>
                                                	<i class='btn-icon-only icon-edit'></i>
                                            	</a>
                                           		<a href='del_item.php?opt=2&item_id=$r[0]' onClick='confirmDelete();' class='btn btn-small btn-danger'>
