...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="update `item` set `item`='".$item."', `description`='".$description."', category='".$category."' where item_id='".$item_id."'";
				mysql_query($q);
				header('location:item_mgmt.php');
			}
			$item_id=$_REQUEST['item_id'];
        	$res=mysql_query("select * from item where item_id='".$item_id."'");
				...
				<div class="container">
					<div class="row">
						<div id="acct-password-row" class="span16">
							<fieldset>
								<legend>Edit Item</legend><br>
									<div class="control-group ">
										<label class="control-label">Item Name</label>
											<div class="controls">
												<input id="item" name="item" class="span4" type="text" value="<?php echo $item; ?>" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">Category</label>
											<div class="controls">
												<select name="category">
                                                	<?php
                                                    	$res1=mysql_query("select * from category where category_id='".$category."'");
									...
									<div class="control-group ">
										<label class="control-label">Description</label>
											<div class="controls">
                                                ...
                                                <input id="item_id" name="item_id" class="span4" type="hidden" value="<?php echo $item_id; ?>" autocomplete="false" required>
											</div>
									</div>
							</fieldset>
						</div>
