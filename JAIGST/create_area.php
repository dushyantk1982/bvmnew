...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="INSERT INTO `area` (`area_id`, `area_name`) VALUES ('', '".$area."')";
				mysql_query($q);
				...
				<div class="container">
					<div class="row">
						<div id="acct-password-row" class="span16">
							<fieldset>
								<legend>Add New Area</legend><br>
									<div class="control-group ">
										<label class="control-label">Area Name</label>
											<div class="controls">
												<input id="area" name="area" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
									<!--<div class="control-group ">
