...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="update `bank` set `bank`='".$bank."', `bank_add`='".$bank_add."', `account_name`='".$account_name."', `account_no`='".$account_no."', `account_type`='".$account_type."', `IFSC`='".$IFSC."', `SWIFT`='".$SWIFT."' where bank_id='".$bank_id."'";
				mysql_query($q);
				header('location:bank_mgmt.php');
			}
			$bank_id=$_REQUEST['bank_id'];
        	$res=mysql_query("select * from bank where bank_id='".$bank_id."'");
				...
				<div class="container">
					<div class="row">
						<div id="acct-password-row" class="span16">
							<fieldset>
								<legend>Add New Bank</legend><br>
									<div class="control-group ">
										<label class="control-label">Bank Name</label>
											<div class="controls">
												<input id="bank" name="bank" class="span4" type="text" value="<?php echo $bank; ?>" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
										<label class="control-label">Address</label>
											<div class="controls">
												<input id="bank_add" name="bank_add" class="span4" type="text" value="<?php echo $bank_add; ?>" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">Account Holding Name</label>
											<div class="controls">
												<input id="account_name" name="account_name" class="span4" type="text" value="<?php echo $account_name; ?>" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">Account No.</label>
											<div class="controls">
												<input id="account_no" name="account_no" class="span4" type="text" value="<?php echo $account_no; ?>" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
                                    ...
                                    <div class="control-group ">
										<label class="control-label">IFSC Code</label>
											<div class="controls">
												<input id="IFSC" name="IFSC" class="span4" type="text" value="<?php echo $IFSC; ?>" autocomplete="false" required>
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">SWIFT BIC Code</label>
											<div class="controls">
												<input id="SWIFT" name="SWIFT" class="span4" type="text" value="<?php echo $SWIFT; ?>" autocomplete="false" required>
                                                <input id="bank_id" name="bank_id" class="span4" type="text" value="<?php echo $bank_id; ?>" autocomplete="false" required>
											</div>
									</div>
							</fieldset>
						</div>
