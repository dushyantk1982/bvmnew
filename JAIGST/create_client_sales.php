...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="INSERT INTO `client` (`client_id`, `client_name`, `address`, `city`, `state`, `country`, `pin`, `contact`, `mobile`, `mail`, `PAN`, `TIN`, `ST`, `CST`) VALUES ('', '".$client_name."', '".$address."', '".$city."', '".$state."', '".$country."', '".$pin."', '".$contact."', '".$mobile."', '".$mail."', '".$pan."', '".$tin."', '".$st."', '".$cst."')";
				mysql_query($q);
								...
								<legend>Company/Firm Detail</legend><br>
									...
									<div class="control-group ">
										<label class="control-label">Pin</label>
											<div class="controls">
												<input id="pin" name="pin" class="span4" type="text" value="474001" autocomplete="false" >
											</div>
									</div>
									<div class="control-group ">
										<label class="control-label">Telephone</label>
											<div class="controls">
												<input id="contact" name="contact" class="span4" type="text" value="" autocomplete="false" >
											</div>
									</div>
									<div class="control-group ">
									...
									<div class="control-group ">
										<label class="control-label">Mail ID</label>
											<div class="controls">
												<input id="mail" name="mail" class="span4" type="text" value="" autocomplete="false" >
											</div>
									</div>
