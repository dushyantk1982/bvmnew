				...
				<div class="container">
					<div class="row">
                        ...
                        <a href="create_sales.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Create New Invoice</button></a>
                         <a href="create_sales_1.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Create New Sales</button></a>
								...
								$s=1;
										...
										while($r=mysql_fetch_array($res))
										{
											echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td>".$r[3]."</td><td>".$r[4]."</td><td>".$r[5]."</td><td>".$r[6]."</td><td>".$r[7]."</td><td>".$r[8]."</td>";?><td class='td-actions'>
                                                ...
                                                <?php
												echo "<a href='edit_sales.php?invoice_no=$r[1]' class='btn btn-small btn-info'>
