...
<!-- Start BODY -->
				...
				<div class="container">
					<div class="row">
						<div id="acct-password-row" class="span16">
							<fieldset>
								<legend>Add New Category</legend><br>
									<div class="control-group ">
										<label class="control-label">Category Name</label>
											<div class="controls">
												<input id="category" name="category" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
    ...
    <?php
			...
			{
				extract($_POST);
				$q="INSERT INTO `category` (`category_id`, `category`, `description`) VALUES ('', '".$category."', '".$description."')";
				mysql_query($q);
