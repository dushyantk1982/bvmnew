					...
					<div class="row">
						<div id="acct-password-row" class="span16">
                        	<table width="100%">
                                ...
                                <tr><td>Date</td><td><?php echo $_POST['date']; ?><input type="hidden" name="inv_date" value="<?php echo $_POST['date']; ?>" class="span4" autocomplete="false" required></td></tr>
                               						 
                                <tr><td>Invoice No</td><td><?php echo $_POST['inv_no']; ?><input type="hidden" name="inv_no" value="<?php echo $_POST['inv_no']; ?>" class="span4" autocomplete="false" required></td></tr>
                                <tr><td>State</td><td><?php echo $_POST['state']; ?><input type="hidden" name="state" value="<?php echo $_POST['state']; ?>" class="span4" autocomplete="false" required></td></tr>
                                <tr><td>Client Name</td><td>
                                <?php echo $_POST['client_id']; ?><input type="hidden" name="client_id" value="<?php echo $_POST['client_id']; ?>" class="span4" autocomplete="false" required></td></tr>
                                                <tr><td><input type="hidden" name="count" value="<?php echo $_POST['count']; ?>" onKeyUp="total()" />
                                                <?php
                                                	$res2=mysql_query('select ayur_rate, type from client');
                                  ...
                                  <tr>
                                  	...
                                  	<td colspan="2">
                                  		<table>
                                            ...
                                            <tr>
                                            	<td>
                                                	<select id="item_id[]" name="item_id[]" class="span4" onChange="Stock(this.value)">
                                                ...
                                                <?php
                                                	/*if($tp=1)
													{
														echo $price=($mrp[$i]/1.15)/$ar;	
													}
													else
													{
														echo $price=$mrp[$i]-(($mrp[$i]*$ar)/100);
													}*/
												?>
                                                </td>-->
