<ul> <li>
                                ...
                                <li>
                                    <a href="vendor_purchase_report.php">
                                        <i class="icon-user icon-large"></i> Vendor Wise
                                    </a>
                                </li>
								<li>
                                    <a href="product_purchase_report.php">
                                        <i class="icon-glass icon-large"></i> Product Wise
                                    </a>
                                </li>
                                <li>
