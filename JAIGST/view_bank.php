								...
								<legend>Add New Bank</legend><br>
									<div class="control-group ">
										<!--<label class="control-label">Bank Name</label>-->
											<div class="controls">
												<?php echo $r[1]; ?><!--<input id="bank" name="bank" class="span4" type="text" value="" autocomplete="false" required>-->
											</div>
									</div>
									<div class="control-group ">
										<!--<label class="control-label">Address</label>-->
											<div class="controls">
												<?php echo $r[2]; ?><!--<input id="bank_add" name="bank_add" class="span4" type="text" value="" autocomplete="false" required>-->
											</div>
									</div>
                                    <div class="control-group ">
										<!--<label class="control-label">Account Holding Name</label>-->
											<div class="controls">
												<?php echo $r[3]; ?><!--<input id="account_name" name="account_name" class="span4" type="text" value="" autocomplete="false" required>-->
											</div>
									</div>
                                    <div class="control-group ">
										<!--<label class="control-label">Account No.</label>-->
											<div class="controls">
												<?php echo $r[4]; ?><!--<input id="account_no" name="account_no" class="span4" type="text" value="" autocomplete="false" required>-->
											</div>
									</div>
                                    <div class="control-group ">
										<!--<label class="control-label">Account Type</label>-->
											<div class="controls">
												<?php echo $r[5]; ?> Account<!--<select name="account_type">
                                    ...
                                    <div class="control-group ">
										<!--<label class="control-label">IFSC Code</label>-->
											<div class="controls">
												IFSC Code : <?php echo $r[6]; ?><!--<input id="IFSC" name="IFSC" class="span4" type="text" value="" autocomplete="false" required>-->
											</div>
									</div>
                                    <div class="control-group ">
										<!--<label class="control-label">SWIFT BIC Code</label>-->
											<div class="controls">
												SWIFT BIC Code : <?php echo $r[7]; ?><!--<input id="SWIFT" name="SWIFT" class="span4" type="text" value="" autocomplete="false" required>-->
											</div>
									</div>
							</fieldset>
						</div>
