...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="INSERT INTO `client` (`client_id`, `client_name`, `address`, `area_id`, `mobile`, `GST`, `code`, `ayur_rate`,`type`) VALUES ('', '".$client_name."', '".$address."', '".$area."', '".$mobile."', '".$gst."', '".$code."', '".$ayur_rate."', '".$type."')";
				mysql_query($q);
								...
								<legend>Company/Firm Detail</legend><br>
									<div class="control-group ">
										<label class="control-label">Name: </label>
											<div class="controls">
												<input id="client_name" name="client_name" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
										...
										<label class="control-label">Location</label>
											<div class="controls">
												<select name="area">
													...
													?>
                                                </select><!--<input id="address" name="address" class="span4" type="text" value="" autocomplete="false" >-->
											</div>
									</div>
									...
									<div class="control-group ">
										<label class="control-label">Mobile</label>
											<div class="controls">
												<input id="mobile" name="mobile" class="span4" type="text" value="" autocomplete="false" >
											</div>
									</div>
								...
								<legend>Tax Details</legend><br>
									...
									<div class="control-group ">
										<label class="control-label">State Code</label>
											<div class="controls">
												<input id="code" name="code" class="span4" type="text" value="23" autocomplete="false">
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">Ayur Rate</label>
											<div class="controls">
												<input id="ayur_rate" name="ayur_rate" class="span4" type="text" value="" autocomplete="false">
											</div>
									</div>
                                    <div class="control-group ">
										<label class="control-label">Shop Type</label>
											<div class="controls">
												<Select name="type">
                                                    ...
                                                    <option value="WH">Whole Saller</option>
                                                </Select>
											</div>
									</div>
