...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="INSERT INTO `currency` (`currency_id`, `currency`, `description`) VALUES ('', '".$symbol."', '".$description."')";
				mysql_query($q);
								...
								<legend>Add New Currency</legend><br>
									<div class="control-group ">
										<label class="control-label">Currency Symbol </label>
											<div class="controls">
												<input id="symbol" name="symbol" class="span4" type="text" value="" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
