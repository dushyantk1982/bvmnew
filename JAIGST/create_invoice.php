				...
				<div class="container">
					<div class="row">
						<div id="acct-password-row" class="span16">
                        	<table width="100%">
                            	<tr><td>Date</td><td><input type="date" name="inv_date" value="date" class="span4" autocomplete="false" required></td></tr>
                                <tr><td>Client Name</td><td><select name="client_id" required>
                                 ...
                                 <tr><td>Item Name</td><td><select name="item_id" required>
                                  ...
                                  <tr>
                                  	<td colspan="2">
                                  		<table>
                                            ...
                                            <?php for($i=1; $i<=5; $i++){ ?>
                                            <tr>
                                            	<td><input id="description" name="description" class="span4" type="text" value="" autocomplete="false" required></td>
                                                <td><input id="qty" name="qty" class="span4" type="text" onKeyUp="total()" value="" autocomplete="false" required></td>
                                                <td><input id="price" name="price" class="span4" type="text" onKeyUp="total()" value="" autocomplete="false" required></td>
                                                <td><input id="value" name="value" class="span4" type="text" onKeyUp="total()" value="" autocomplete="false" required></td>
                                            </tr><?php } ?>
                                            <tr></tr>
                                            <tr></tr>
								...
								<!--<legend>Order Detail</legend><br>
									<div class="control-group ">
										<label class="control-label">Invoice Date </label>
											<div class="controls">
												<input id="order_date" name="order_date" class="span4" type="date" value="<?php //echo date(DATE_ATOM); ?>" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
