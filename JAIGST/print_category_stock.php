			    ...
			    <section id="my-account-security-form" class="page container">
                       ...
                       <div class="row" style="margin-top: 25px;">
            				<div class="span16">
								...
								?>
                                	<span style="border-bottom:1px solid;"><?php echo $cat_name; ?></span><br/>
                                    <span style="border-bottom:1px solid;">Current Stock <?php echo "As on ".date("d-m-Y"); ?></span><br/>
                                    <!--<span style="border-bottom:1px solid;"></span><br/>-->
								...
								<?php
										...
										$i=1;
										//echo $category_id;
									$res=mysql_query("select item_id, item, MRP, opening, baserate, igst from item where category='".$category_id."'");
