		...
		<section id="my-account-security-form" class="page container">
				...
				<div class="container">
					<div class="row">
                        ...
                        <a href="create_user.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Add User</button></a>
                                ...
                                <?php
										...
										while($r=mysql_fetch_array($res))
										{
											echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td class='td-actions'>
                                            	<a href='edit_users.php?opt=3&users_id=$r[0]' class='btn btn-small btn-info'>
                                                	<i class='btn-icon-only icon-edit'></i>
                                            	</a>
                                           		<a href='del_users.php?opt=2&users_id=$r[0]' onClick='confirmDelete();' class='btn btn-small btn-danger'>
