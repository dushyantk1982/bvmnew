		...
		<section id="my-account-security-form" class="page container">
				...
				<div class="container">
					<div class="row">
                        ...
                        <a href="create_currency.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Add New Currency</button></a>
                                ...
                                <?php
										...
										while($r=mysql_fetch_array($res))
										{
											echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td class='td-actions'>
                                            	<a href='edit_currency.php?opt=3&currency_id=$r[0]' class='btn btn-small btn-info'>
                                                	<i class='btn-icon-only icon-edit'></i>
                                            	</a>
                                           		<a href='del_currency.php?opt=2&currency_id=$r[0]' onClick='confirmDelete();' class='btn btn-small btn-danger'>
