        ...
        <div id="body-content">
			...
			if($_REQUEST['submit']=='Save')
			{
				...
				for($i=0;$i<count($item_id);$i++)
				{
					...
					{$cl_stk=$r1[8];}
					$cl_stk=$cl_stk-$qty[$i];
					$q1="INSERT INTO `item_stock` (`stock_id`, `date`, `invoice_no`, `item_id`, `pur_qty`, `pur_rate`, `sales_qty`, `sales_rate`, `base_amt`, `cgst_rate`, `cgst`, `sgst_rate`, `sgst`, `net_amt`, `balance_qty`) VALUES ('', '".$inv_date."', '".$inv_no."', '".$item_id[$i]."', '0', '0.00', '".$qty[$i]."', '".$baserate[$i]."', '".$netval[$i]."', '".$rcgst[$i]."', '".$cgst[$i]."', '".$rsgst[$i]."', '".$sgst[$i]."', '".$netamt[$i]."', '".$cl_stk."')";
				...
				$res8=mysql_query("select * from sales where invoice_no='".$inv_no."'");
				...
				mysql_query("UPDATE `sales` SET `totalnetval`='".$new_totalnetval."',`cgst`='".$new_cgst."',`sgst`='".$new_sgst."',`grossamount`='".$new_grossamount."',`netamount`='".$new_netamount."' WHERE invoice_no='".$inv_no."'");
				
							
				mysql_query("UPDATE `debtors` SET `inv_value`='".$new_netamount."' WHERE ref_id='".$inv_no."'");
				
				$res2=mysql_query("select * from gstdetail where invoice_no='".$inv_no."'");
				...
				mysql_query("update gstdetail set totalnetval='".$new_totalnetval."', cgst9='".$new_cgst9."', cgst6='".$new_cgst6."', cgst25='".$new_cgst25."', cgst14='".$new_cgst14."', cgst0='".$new_cgst0."', sgst9='".$new_sgst9."', sgst6='".$new_sgst6."', sgst25='".$new_sgst25."', sgst14='".$new_sgst14."', sgst0='".$new_sgst0."', netamount='".$new_netamount."' where invoice_no='".$inv_no."'");
	...
	<div class="box-content">
		<section id="my-account-security-form" class="page container">
			<form action="" name="count" method="post">
				...
				?>
                <input type="text" name="count" placeholder="No of Rows" value="<?php echo $_REQUEST['count']; ?>" />
