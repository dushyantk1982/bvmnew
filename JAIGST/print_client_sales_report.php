            				...
            				<div class="span16">
                                ...
                                <div align="center" style="margin-top:20px;">
                                	<?php 
										$cl=$_REQUEST['client'];
										include('DAL/database.php');
										$res3=mysql_query("select * from client where client_id='".$cl."'");
								...
								<?php
										...
										echo '<div class="box-content box-table">
                            					<table id="sample-table" class="table table-hover table-bordered tablesorter" >
                              					  <thead>
														...
														<th style="border-bottom:1px solid; border-top:1px solid;">Gross Sales</th>
														<th style="border-bottom:1px solid; border-top:1px solid;">Discount</th>
										...
										$res=mysql_query("SELECT s.date, s.invoice_no, c.client_name, s.totalnetval, s.cgst, s.sgst, s.grossamount, s.discount, s.netamount  FROM `sales` as `s` INNER JOIN `client` as `c` on `s`.`client_id`=`c`.`client_id` where (s.date BETWEEN '".$date_from."' and '".$date_to."') AND s.client_id='".$client."'");
										...
										while($r=mysql_fetch_array($res))
										{
											...
											echo "<tr ><td>&nbsp;&nbsp;".$ndt."&nbsp;&nbsp;</td><td>&nbsp;&nbsp;".$r[1]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[3]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[4]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[5]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[6]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[7]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[8]."&nbsp;&nbsp;</td></tr>";
											$i=$i+1;												
										}
										$res1=mysql_query("select sum(totalnetval)  as totalnetval, sum(cgst) as cgst, sum(sgst) as sgst, sum(grossamount) as grossamount, sum(discount) as discount, sum(netamount) as netamount from sales where (date BETWEEN '".$date_from."' and '".$date_to."') AND client_id='".$client."'");
										while($r1=mysql_fetch_array($res1))
										{
											echo "<tr><td colspan='2' align='center' style='border-bottom:1px solid; border-top:1px solid;'><b>Total</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['totalnetval']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['cgst']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['sgst']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['grossamount']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['discount']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['netamount']."&nbsp;&nbsp;</b></td></tr>";				
										}
										echo "</table>";
