                       ...
                       <div class="row" style="margin-top: 25px;">
            				<div class="span16">
                            	...
                            	<?php
									...
									/*$total=0;
									$res=mysql_query("select sum(inr_value) as aud from currency_value where currency_id!=1");
									$r=mysql_fetch_assoc($res);
									$aud=$r['aud'];
									$res1=mysql_query("select sum(netvalue) as inr from order_book where currency_id=1");
									$r1=mysql_fetch_assoc($res1);
									$inr=$r1['inr'];*/
									
									//echo "Sales Out of India : INR ".$aud."<br/>";
									
									//echo "Sales in India     : INR ".$inr."<br/>";
									//$total=$aud+$inr;
									//echo "Total Sales Value  : INR ".$total;
									
									
									
								?>
                                <!--<table>
                                	<tr><td>Sales Out of India :</td><td align="right"><?php //echo $aud.".00 INR"; ?></td></tr>
                                    <tr><td>Sales in India :</td><td align="right"><?php //echo $inr.".00 INR"; ?></td></tr>
                                    <tr><td>Total Sales Value :</td><td align="right"><?php //echo $total.".00 INR"; ?></td></tr>
                                </table>-->
                                    
								<!--<a href="users.php?opt=1"><button id="submit-button" type="button" class="btn btn-primary" name="action" value="" style="margin-bottom:20px">Currency Setting</button></a>
