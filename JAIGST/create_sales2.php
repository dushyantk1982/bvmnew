					...
					<div class="row">
						<div id="acct-password-row" class="span16">
                        	<table width="100%">
                                ...
                                <tr><td>State</td><td><input type="text" name="state" value="<?php echo $_POST['state']; ?>" class="span5">
                                </td></tr>
                                <tr><td>Client Name</td><td><input type="text" name="client_id" value="<?php echo $_POST['client_id']; ?>" class="span5">
                                </td></tr>
                                  ...
                                  <tr>
                                  	...
                                  	<td colspan="2">
                                  		<table>
                                            ...
                                            <tr>
                                            	<td><?php $item=$_POST['item_id["'.$i.'"]']; 
												echo $item;?>
                                                	<input type="text" id="item_id[]" name="item_id[]" class="span5" value="<?php echo $item_id[$i]; ?>">
                                                	
                                                <!--<input id="description" name="description" class="span4" type="text" value="" autocomplete="false" required>--></td>
                                                <td><input id="qty<?php echo $i; ?>" name="qty[]" class="span2" type="text" value="<?php echo $_POST['qty[$i]'];?>" onKeyUp="total(<?php echo $i; ?>)" autocomplete="false" required></td>
