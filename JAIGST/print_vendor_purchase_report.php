                       ...
                       <div class="row" style="margin-top: 25px;">
            				<div class="span16">
                                ...
                                <div align="center" style="margin-top:20px;">
                                	<?php 
										$cl=$_REQUEST['vendor_id'];
										include('DAL/database.php');
										$res3=mysql_query("select * from vendors where vendor_id='".$cl."'");
								...
								<?php
										...
										while($r=mysql_fetch_array($res))
										{
											...
											$v=$r[3]+$r[4]+$r[5];
											echo "<tr ><td>&nbsp;&nbsp;".$ndt."&nbsp;&nbsp;</td><td>&nbsp;&nbsp;".$r[1]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[3]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[4]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[5]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$v."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[6]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[7]."&nbsp;&nbsp;</td></tr>";
											$i=$i+1;
										...
										{
											echo "<tr><td colspan='2' align='center' style='border-bottom:1px solid; border-top:1px solid;'><b>Total</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['totalnetval']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['cgst']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['sgst']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$gross."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['discount']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['netamount']."&nbsp;&nbsp;</b></td></tr>";				
										}
										echo "</table>";
