...
<!-- Start BODY -->
    ...
    <div id="body-container">
        <div id="body-content">
			...
			{
				extract($_POST);
				$q="update `currency` set `currency`='".$symbol."', `description`='".$description."' where currency_id='".$currency_id."'";
				mysql_query($q);
				header('location:currency_mgmt.php');
			}
			$currency_id=$_REQUEST['currency_id'];
        	$res=mysql_query("select * from currency where currency_id='".$currency_id."'");
				...
				<div class="container">
					<div class="row">
						<div id="acct-password-row" class="span16">
							<fieldset>
								<legend>Add New Currency</legend><br>
									<div class="control-group ">
										<label class="control-label">Currency Symbol </label>
											<div class="controls">
												<input id="symbol" name="symbol" class="span4" type="text" value="<?php echo $r[1]; ?>" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
										<label class="control-label">Description</label>
											<div class="controls">
                                                ...
                                                <input id="currency_id" name="currency_id" class="span4" type="hidden" value="<?php echo $r[0]; ?>" autocomplete="false" required>
											</div>
									</div>
							</fieldset>
						</div>
