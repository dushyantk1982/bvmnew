                       ...
                       <div class="row" style="margin-top: 25px;">
            				<div class="span16">
                                ...
                                <div align="center" style="margin-top:20px;">
                                	<span style="border-bottom:1px solid;">Purchase Report</span><br/>
								...
								<?php
										...
										echo '<div class="box-content box-table">
                            					<table id="sample-table" class="table table-hover table-bordered tablesorter" >
                              					  <thead>
														...
														<th style="border-bottom:1px solid; border-top:1px solid;">Gross Purchase</th>
										...
										$res=mysql_query("SELECT purchase.date, purchase.invoice_no, vendors.vendor_name, purchase.totalnetval, purchase.cgst, purchase.sgst, purchase.discount, purchase.netamount  FROM `purchase` JOIN vendors on purchase.vendor_id=vendors.vendor_id where date BETWEEN '".$date_from."' and '".$date_to."'");
										...
										while($r=mysql_fetch_array($res))
										{
											...
											$v=$r[3]+$r[4]+$r[5];
											echo "<tr ><td>&nbsp;&nbsp;".$ndt."&nbsp;&nbsp;</td><td>&nbsp;&nbsp;".$r[1]."&nbsp;&nbsp;</td><td >&nbsp;&nbsp;".$r[2]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[3]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[4]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[5]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$v."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[6]."&nbsp;&nbsp;</td><td align='right'>&nbsp;&nbsp;".$r[7]."&nbsp;&nbsp;</td></tr>";
											$i=$i+1;	
											$gross=$gross+$r[3]+$r[4]+$r[5];																							
										}
										$res1=mysql_query("select sum(totalnetval)  as totalnetval, sum(cgst) as cgst, sum(sgst) as sgst, sum(discount) as discount, sum(netamount) as netamount from purchase where date between '".$date_from."' and '".$date_to."'");
										while($r1=mysql_fetch_array($res1))
										{
											echo "<tr><td colspan='3' align='center' style='border-bottom:1px solid; border-top:1px solid;'><b>Total</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['totalnetval']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['cgst']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['sgst']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$gross."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['discount']."&nbsp;&nbsp;</b></td><td style='border-bottom:1px solid; border-top:1px solid;' align='right'><b>&nbsp;&nbsp;".$r1['netamount']."&nbsp;&nbsp;</b></td></tr>";				
										}
										echo "</table>";
