            				...
            				<div class="span16">
								...
								<?php
                                	if($_REQUEST['submit']=='Search')
									{
										...
										$i=1;
										?>
										<a href="JavaScript:newPopup('print_client_product_sales_report.php?date_from=<?php echo $date_from; ?>&date_to=<?php echo $date_to;?>&client=<?php echo $client;?>');" class="btn btn-small btn-info">Print Report</a>
										<?php 
										$res3=mysql_query("select client_name from client where client_id='".$client."'");
