    ...
    <div id="body-container">
        <div id="body-content">
			...
			if($_REQUEST['submit']=='Save')
			{
				...
				if($area!='')
				{
				$q="update `area` set `area_name`='".$area."' where area_id='".$area_id."'";
				mysql_query($q);
				}
				header('location:area_mgmt.php');
			}
			$area_id=$_REQUEST['area_id'];
        	$res=mysql_query("select * from area where area_id='".$area_id."'");
				...
				<div class="container">
					<div class="row">
						<div id="acct-password-row" class="span16">
							<fieldset>
								<legend>Edit Area</legend><br>
									<div class="control-group ">
										<label class="control-label">Area Name</label>
											<div class="controls">
												<input id="area" name="area" class="span4" type="text" value="<?php echo $r[1]; ?>" autocomplete="false" required>
											</div>
									</div>
									<div class="control-group ">
										<!--<label class="control-label">Description</label>-->
											<div class="controls">
                                                ...
                                                <input id="area_id" name="area_id" class="span4" type="hidden" value="<?php echo $r[0]; ?>" autocomplete="false" required>
											</div>
									</div>
							</fieldset>
						</div>
